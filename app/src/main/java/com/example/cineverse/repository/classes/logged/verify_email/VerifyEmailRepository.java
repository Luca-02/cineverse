package com.example.cineverse.repository.classes.logged.verify_email;
...
/**
 * The {@code VerifyEmailRepository} class extends {@link AbstractLoggedRepository} and provides functionality
...
public class VerifyEmailRepository
    ...
    /**
     * Constructs a {@code VerifyEmailRepository} object with the given Application context and initializes
     ...
     */
    public VerifyEmailRepository(Context context) {
        super(context);
